    ...
    switch (task.type) {
        case "www.douyin":
            ...
            try {
                ...
                return { success: false, reason: "Failed to fetch data from Douyin API." };
            }
            break;
        case "vm.tiktok":
        case "www.tiktok":
            ...
            try {
                ...
                return { success: false, reason: "Failed to fetch data from TikTok API." };
            }
            break;
        default:
            return {
                success: false,
                reason: "The content of the clipboard is not a valid TikTok/Douyin URL."
            };
    }
    return {
        success: true,
