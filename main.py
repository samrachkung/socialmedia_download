...
while True:
    try:
        ...
        class editVideo:
            ...
            def __init__(self):
                ...
                if __name__ == "__main__":
                 ...
                 ██║ ╚██╗  ███████║  ██║  ██║   ██╔╝ ██╗           ███████╗  ██████╔╝  ██║     ██║       ╚██╔╝    ██║  ██████╔╝  ███████╗  ╚█████╔╝
                 ╚═╝  ╚═╝  ╚══════╝  ╚═╝  ╚═╝   ╚═╝  ╚═╝           ╚══════╝  ╚═════╝   ╚═╝     ╚═╝        ╚═╝     ╚═╝  ╚═════╝   ╚══════╝   ╚════╝
                             Tool By Kungsamrach ==> Facebook : Samrach kung {Fore.YELLOW}
                    """
        ...
        class downDouyin():
            ...
            def __init__(self):
                ...
                if __name__ == "__main__":
                  ...
                  ██║ ╚██╗  ███████║  ██║  ██║   ██╔╝ ██╗        ██████╔╝╚█████╔╝╚██████╔╝░░░██║░░░██║██║░╚███║░░░░░░██████╔╝███████╗
                  ╚═╝  ╚═╝  ╚══════╝  ╚═╝  ╚═╝   ╚═╝  ╚═╝        ╚═════╝░░╚════╝░░╚═════╝░░░░╚═╝░░░╚═╝╚═╝░░╚══╝░░░░░░╚═════╝░╚══════╝
                    Tool By Kungsamrach ==> Facebook : Samrach kung {Fore.GREEN}
                            """
                ...
                def api1():
                    ...
                    while not KeyError:
                        try:
                            ...
                            querystring = {"unique_id":"", "count":"100 ","cursor":"0"}
        ...
        if __name__ == "__main__":
            ...
            os.system("cls" if os.name == "nt" else "clear"); os.system("title Tool by Rach" if os.name == "nt" else "")
            txt = f"""{Fore.MAGENTA}
